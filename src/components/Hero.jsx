  ...
  return (
    <section id="home" className="relative overflow-hidden bg-[#09090b] pt-32 sm:pt-40 pb-20 sm:pb-28 px-4 sm:px-8 lg:px-14">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        <div className="absolute -top-40 left-1/2 -translate-x-1/2 w-[800px] sm:w-[1100px] h-[500px] rounded-full bg-gradient-to-r from-teal-500/10 via-cyan-500/10 to-emerald-500/10 blur-[100px] transform-gpu" />
      </div>
      ...
      <div className="mx-auto max-w-[1280px] flex flex-col lg:flex-row items-center lg:items-start justify-between gap-12 lg:gap-16">
        ...
        <div className="order-1 lg:order-2 w-full max-w-[360px] shrink-0">
          <div className="relative rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-md p-7 text-center group hover:border-teal-500/30 transition-all duration-300 shadow-2xl transform-gpu">
            ...
            <div className="relative inline-block mb-4">
              ...
              <img
                ...
                fetchPriority="high"
                decoding="async"
                className="w-24 h-24 rounded-2xl object-cover mx-auto ring-2 ring-teal-400/40 shadow-xl group-hover:scale-105 transition-transform duration-300 transform-gpu"
              />
