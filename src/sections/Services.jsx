...
const Services = () => {
  return (
    <section id="services" className="relative bg-[#09090b] py-24 sm:py-32 px-4 sm:px-8 lg:px-16 border-t border-white/5">
      
      {/* Background glow accent */}
      <div className="pointer-events-none absolute top-1/3 right-0 w-96 h-96 bg-cyan-500/5 rounded-full blur-[140px]" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-16">
          {services.map((service, index) => (
            <div
              key={index}
              tabIndex={0}
              className="group relative rounded-[24px] border border-white/10 bg-white/[0.025] p-8 backdrop-blur-xl shadow-lg
                hover:border-teal-500/40 hover:bg-white/[0.05] hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between focus:outline-none focus:ring-2 focus:ring-teal-400"
            >
              <div>
